                    ...
                    <div class="box" id="contact">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <p class="text-muted">This number is toll free if calling from Indonesia   otherwise we advise you to use the electronic form of communication.</p>
                                <p><strong>+62 21 14045</strong>
                                </p>
                            </div>
                            <!-- /.col-sm-4 -->
                            <div class="col-sm-4">
                                <h3><i class="fa fa-envelope"></i> Online support</h3>
                                <p class="text-muted">Please feel free to write an email to us or to use our electronic ticketing system.</p>
                                <ul>
                                    <li><strong><a href="mailto:">support@lapakikan.com</a></strong>
                                    </li>
