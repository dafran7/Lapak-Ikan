    ...
    <div id="top">
        <div class="container">
            ...
            <div class="col-md-6" data-animate="fadeInDown">
                <ul class="menu">
                    <li><a href="#" data-toggle="modal" data-target="#login-modal"q>Login</a>
                    </li>
         ...
         <div class="navbar-header">
             ...
             <div class="navbar-buttons">
                 ...
                 <a class="btn btn-default navbar-toggle" href="basket.html">
                     <i class="fa fa-shopping-cart"></i>  <span class="hidden-xs">Jual Barang</span>
                 </a>
             </div>
         </div>
         <!--/.navbar-header -->
...
<div class="container">
  ...
  <div class="form-group">
      ...
      <div class="col-sm-8">
        <input name="alamat" type="text" class="form-control" placeholder="NIM">
      </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
          <input name="notelp" type="text" class="form-control" placeholder="No.Telpon">
        </div>
      </div>
