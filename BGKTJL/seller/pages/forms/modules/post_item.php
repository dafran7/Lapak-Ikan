<?php
	...
	$input = "INSERT INTO item(item_id, nama_item, deskripsi_item, quantity, harga, berat, diskon, penjualan, fresh, pengunjung, gambar_item) VALUES('','$nama','$deskripsi_item','$quantity','$harga','$berat','$diskon','','','','$file_fmt')";
