                        ...
                        <div class="panel panel-default sidebar-menu">
                            ...
                            <div class="panel-body">
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    <li class="active">
                                        <a href="customer-account.html"><i class="fa fa-user"></i> Add New Listings</a>
                                    </li>
                                    <li>
                                        <a href="customer-orders.html"><i class="fa fa-list"></i>Edit My listings</a>
                                    </li>
                                    <li>
                                        <a href="customer-orders.html"><i class="fa fa-list"></i> My Sales</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="customer-account.html"><i class="fa fa-heart"></i> My account</a>
                                    </li>
                                    <li>
                        ...
                        <div class="box">
                            ...
                            <form class="col-md-7 col-md-offset-2 form-horizontal" name="post" action="modules/post_item.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="nama-item">Item Name</label>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="quantity" type="text" class="form-control" id="quantity_item" placeholder="Quantity">
                                        </div>
                                    </div>
                                </div>
                                >
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="harga" type="text" class="form-control" id="item_price" placeholder="Price">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="item-weight">Item Weights</label>
                                            <input name="berat" type="text" class="form-control" id="item_weight" placeholder="Item Weights">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="diskon" type="text" class="form-control" id="discount" placeholder="Discount">
                                        </div>
                                    </div>
                                </div>
