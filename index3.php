...
$query_item = mysqli_query($conn, "SELECT * FROM item ORDER BY item_id DESC LIMIT 10");
$hot_item = mysqli_query($conn, "SELECT * FROM item ORDER BY pengunjung DESC  LIMIT 10")
...
_________________________________________________________ -->
                        ...
                        while ($data = mysqli_fetch_array($query_item)) {
                            ...
                            <div class="item">
                                <div class="product">
                                        ...
                                        <div class="flipper">
                                            <div class="front">
                                                <a href="product.php?id=<?php echo $data['item_id'] ?>">
                                                    <img src="images/<?php echo $data['gambar_item'] ?>" alt=""
                                    ...
                                    <div class="text">
                                        <h3>
                                            <a href="product.php?id=<?php echo $data['item_id'] ?>"><?php echo $data['nama_item'] ?></a>
                                        </h3>
        ...
        <div id="hot">
            ...
            <div class="container">
                <div class="product-slider">
    <?php
                    while ($data = mysqli_fetch_array($hot_item)) {
                    ?>
                    <div class="item">
                        <div class="product">
                            <div class="flip-container">
